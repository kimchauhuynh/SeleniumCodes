...
public class TagName_ListOfAllLinksonaWebPage {
	...
	public static void main(String[] args) {
		...
		//4. Intialize value to variable to keep count of number of links in webpage 
	        ...
	        //5. List is applied on WebElement to collect all the <a> tag in all links reference
	        List<WebElement> allLinks = browserObject.findElements(By.tagName("a"));	//import until List, import By
