...
public class LinkText {
	...
	public static void main(String[] args) {
		//WebDriver browserObject; comment this out, not sure why it's here
		...
		// 4. The value of text link is stored in bloglink reference . Here TextLink is a locator that checks wether a text is link or not.		  
	        WebElement blogLink = browserObject.findElement(By.linkText("Gmail")); //import WebElement
//??NOT SURE WHY WEBELEMENT =BLOGLINK IS ADD TO THIS STATEMENT??				 
