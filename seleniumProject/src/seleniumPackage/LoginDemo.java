...
// similar code for clear the box and then populate it: browserObject.findElement(By.id("Email")).clear();
   //browserObject.findElement(By.id("Email")).sendKeys("mary@yahoo.com");
